...
//This is a fun class that will load the XML document from the documents directory and loads it into an NSMutableArray
@interface WordLoader : NSObject<NSXMLParserDelegate>
